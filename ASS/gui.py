...
class MainWindow:
    ...
    def _create_menu(self):
        ...
        spectrum_menu.add_command(label = "Subtract minimum", command=self.sub_minimum)
        spectrum_menu.add_command(label = "Subtract linear", command=self.sub_linear)
        spectrum_menu.add_command(label = "Subtract spectrum", command=self.sub_spectrum)
        spectrum_menu.add_command(label = "Spectrum normalization", command=self.norm_spectrum)
        spectrum_menu.add_separator()
        spectrum_menu.add_command(label = "Batch filtering", command=self.batch_filtering)
        spectrum_menu.add_command(label = "Batch minimum subtraction", command=self.batch_sub_min)
        spectrum_menu.add_command(label = "Batch linear subtraction", command=self.batch_sub_linear)
        spectrum_menu.add_command(label = "Batch spectrum subtration", command=self.batch_sub_spectrum)
